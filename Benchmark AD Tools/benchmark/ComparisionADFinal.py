#Benchmark Autograd vs AlgoPy vs casADI
...
data_insertion={'A_Function':F,'D_AlgoPy solution':SAP,'E_Autograd solution':SAUT,'F_casADI solution':SCAS,'G_AlgoPy time':TAP,'H_Autograd time':TAUT,'I_casADI time':TCAS}
